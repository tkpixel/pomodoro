...
methods = {
    ...
    'fetchTasks': '''    public CompletableFuture<List<JiraTask>> fetchTasks(String boardId) {
        return CompletableFuture.supplyAsync(() -> {
            try {
    ...
    'fetchBoardConfiguration': '''    public CompletableFuture<BoardConfiguration> fetchBoardConfiguration(String boardId) {
        return CompletableFuture.supplyAsync(() -> {
            try {
