...
public class PomodoroApplication extends Application {
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    FXMLLoader loader =
        new FXMLLoader(getClass().getResource("/com/signongroup/pomodoro/view/MainView.fxml"));
    ...
    String customCss =
        Objects.requireNonNull(getClass().getResource("/css/corporate-design.css"))
            .toExternalForm();
    Scene scene = new Scene(root);
    scene.getStylesheets().add(customCss);

    if (context != null) {
      com.signongroup.pomodoro.view.WindowManager windowManager =
          context.getBean(com.signongroup.pomodoro.view.WindowManager.class);
    ...
    primaryStage
        .getIcons()
        .add(new Image(Objects.requireNonNull(getClass().getResourceAsStream("/Logo.png"))));
