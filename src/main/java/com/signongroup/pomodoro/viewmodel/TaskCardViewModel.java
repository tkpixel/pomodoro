...
public class TaskCardViewModel {
  ...
  private void updateProperties() {
    ...
    Long estSeconds =
        task.fields().timetracking() != null
            ? task.fields().timetracking().originalEstimateSeconds()
            : null;
    Long spentSeconds =
        task.fields().timetracking() != null
            ? task.fields().timetracking().timeSpentSeconds()
            : null;
  ...
  private boolean isTaskCompleted() {
    if (task.fields() != null
        ...
        && task.fields().status().statusCategory() != null) {
  ...
  public StringProperty taskKeyProperty() {
    return taskKey;
  }
  ...
  public StringProperty assigneeInitialsProperty() {
    return assigneeInitials;
  }

  public StringProperty priorityIconLiteralProperty() {
    return priorityIconLiteral;
  }

  public StringProperty priorityIconColorProperty() {
    return priorityIconColor;
  }

  public StringProperty issueTypeIconUrlProperty() {
  ...
  public StringProperty progressPercentageProperty() {
    return progressPercentage;
  }

  public BooleanProperty hasProgressProperty() {
    return hasProgress;
  }

  public BooleanProperty hasStoryPointsProperty() {
    return hasStoryPoints;
  }

  public BooleanProperty hasEpicProperty() {
    return hasEpic;
  }

  public BooleanProperty hasAssigneeProperty() {
    return hasAssignee;
  }

  public BooleanProperty hasIssueTypeIconProperty() {
    return hasIssueTypeIcon;
  }
}
