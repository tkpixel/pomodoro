...
public class SettingsViewController implements Initializable {
  ...
  public void initialize(URL location, ResourceBundle resources) {
    ...
    focusSessionLabel
        .textProperty()
        .bind(viewModel.focusSessionMinutesProperty().asString("%02d:00"));
  ...
  private void updateAutoStartSessionsToggleUI(boolean isOn) {
    ...
    if (isOn) {
      javafx.scene.layout.StackPane.setAlignment(
          autoStartSessionsToggleThumb, javafx.geometry.Pos.CENTER_RIGHT);
    } else {
      javafx.scene.layout.StackPane.setAlignment(
          autoStartSessionsToggleThumb, javafx.geometry.Pos.CENTER_LEFT);
    }
  }
  ...
  private void updateAutoStartToggleUI(boolean isOn) {
    ...
    if (isOn) {
      javafx.scene.layout.StackPane.setAlignment(
          autoStartToggleThumb, javafx.geometry.Pos.CENTER_RIGHT);
    } else {
      javafx.scene.layout.StackPane.setAlignment(
          autoStartToggleThumb, javafx.geometry.Pos.CENTER_LEFT);
    }
  }
  ...
  private void updateEnableSessionSoundToggleUI(boolean isOn) {
    ...
    if (isOn) {
      javafx.scene.layout.StackPane.setAlignment(
          enableSessionSoundToggleThumb, javafx.geometry.Pos.CENTER_RIGHT);
    } else {
      javafx.scene.layout.StackPane.setAlignment(
          enableSessionSoundToggleThumb, javafx.geometry.Pos.CENTER_LEFT);
    }
  }
  ...
  private void updateEnableBreakSoundToggleUI(boolean isOn) {
    ...
    if (isOn) {
      javafx.scene.layout.StackPane.setAlignment(
          enableBreakSoundToggleThumb, javafx.geometry.Pos.CENTER_RIGHT);
    } else {
      javafx.scene.layout.StackPane.setAlignment(
          enableBreakSoundToggleThumb, javafx.geometry.Pos.CENTER_LEFT);
    }
  }
  ...
  public void handleIncFocus() {
    viewModel.incrementFocusSession();
  }

  @FXML
  public void handleDecFocus() {
    viewModel.decrementFocusSession();
  }

  @FXML
  public void handleIncShortBreak() {
    viewModel.incrementShortBreak();
  }

  @FXML
  public void handleDecShortBreak() {
    viewModel.decrementShortBreak();
  }

  @FXML
  public void handleIncLongBreak() {
    viewModel.incrementLongBreak();
  }

  @FXML
  public void handleDecLongBreak() {
    viewModel.decrementLongBreak();
  }

  @FXML
  public void handleIncMaxSessions() {
    viewModel.incrementMaxSessionCount();
  }

  @FXML
  public void handleDecMaxSessions() {
    viewModel.decrementMaxSessionCount();
  }
