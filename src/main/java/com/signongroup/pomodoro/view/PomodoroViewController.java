...
public class PomodoroViewController implements Initializable {
    ...
    @Inject
    public PomodoroViewController(PomodoroViewModel viewModel, WindowManager windowManager, com.signongroup.pomodoro.viewmodel.StatisticsViewModel statisticsViewModel, com.signongroup.pomodoro.viewmodel.JiraBoardViewModel jiraBoardViewModel) {
