...
import com.signongroup.focus.viewmodel.StatisticsViewModel;
...
public class StatisticsOverlayViewController implements Initializable {
    ...
    @FXML
    private Label sprintClearedLabel;
    @FXML
    private Label sprintPlannedLabel;
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        clearedTodayLabel.textProperty().bind(statisticsViewModel.clearedTodayProperty().asString("%02d"));
