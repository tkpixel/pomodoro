...
public class MainViewController implements Initializable {
    ...
    @Inject
    public MainViewController(WindowManager windowManager,
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        trackingService.activeModeProperty().addListener((obs, oldMode, newMode) ->
            loadSubView(newMode));
    ...
    private void loadSubView(TrackingService.TrackingMode mode) {
        String fxmlPath = (mode == TrackingService.TrackingMode.POMODORO)
            ? "/com/signongroup/focus/view/FocusView.fxml"
            : "/com/signongroup/focus/view/StopwatchView.fxml";
        try {
