...
import com.signongroup.focus.viewmodel.FocusViewModel.TimerState;
 ...
 */
@Prototype
public class FocusViewController implements Initializable {
    ...
    private final FocusViewModel viewModel;
    private final WindowManager windowManager;
    private final com.signongroup.focus.viewmodel.StatisticsViewModel statisticsViewModel;
    private final com.signongroup.focus.viewmodel.JiraBoardViewModel jiraBoardViewModel;

    @Inject
    public FocusViewController(FocusViewModel viewModel, WindowManager windowManager, com.signongroup.focus.viewmodel.StatisticsViewModel statisticsViewModel, com.signongroup.focus.viewmodel.JiraBoardViewModel jiraBoardViewModel) {
    ...
    public void handleOpenStatistics(ActionEvent event) {
        if (statisticsOverlayController != null) {
            com.signongroup.focus.viewmodel.BoardViewModel currentBoard = jiraBoardViewModel.getSelectedBoard();
            com.signongroup.focus.model.jira.JiraBoard dummyBoard = null;
            if (currentBoard != null) {
                dummyBoard = new com.signongroup.focus.model.jira.JiraBoard(
                        currentBoard.id(),
                        currentBoard.name(),
                        currentBoard.type(),
