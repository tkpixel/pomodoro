/**
 * Wurzelpaket der Focus-Applikation.
 *
 ...
 *
 * <ul>
 *   <li>{@link com.signongroup.focus.Launcher} – reiner JavaFX-Startpunkt, der die
 ...
 *   <li>{@link com.signongroup.focus.FocusApplication} – erweitert
 ...
 * <pre>
 * ┌──────────────────────────────────────────────────────────────┐
 * │  com.signongroup.focus          (Composition Root / App)  │
 * │  com.signongroup.focus.view     (View  – FXML + Controller)│
 * │  com.signongroup.focus.viewmodel(ViewModel – Zustand/Logik)│
 * │  com.signongroup.focus.model    (Model  – Domänenobjekte)  │
 * │  com.signongroup.focus.service  (Service – Geschäftslogik) │
 * └──────────────────────────────────────────────────────────────┘
 * </pre>
 *
