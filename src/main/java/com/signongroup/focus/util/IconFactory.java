package com.signongroup.focus.util;

import org.kordamp.ikonli.javafx.FontIcon;

/**
 * Utility factory for FontIcons to centralize icon literals, enforce default sizes,
 * and provide programmatic builder methods to reduce boilerplate.
 */
public final class IconFactory {
    ...
    /**
     * Instantiates a new FontIcon with the specified size and appends "app-icon" to its style classes.
     *
    ...
    /**
     * Instantiates a new FontIcon defaulting to 16px size and appends "app-icon" to its style classes.
     *
     * @param iconLiteral the FluentUI icon literal
     * @return the newly created FontIcon
     */
     ...
     * @return the newly created FontIcon
     */
    public static FontIcon createWithClass(final String iconLiteral, final int size, final String customCssClass) {
