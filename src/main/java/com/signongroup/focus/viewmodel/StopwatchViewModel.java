...
public class StopwatchViewModel {
    ...
    public StopwatchViewModel(JiraBoardService jiraBoardService, ActiveTaskService activeTaskService, FocusViewModel mainViewModel, TrackingService trackingService) {
