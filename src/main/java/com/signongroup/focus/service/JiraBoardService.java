...
import com.signongroup.focus.model.jira.BoardConfiguration;
import com.signongroup.focus.model.jira.IssueType;
import com.signongroup.focus.model.jira.JiraBoard;
import com.signongroup.focus.model.jira.JiraTask;
import com.signongroup.focus.model.jira.JiraTransition;
import com.signongroup.focus.model.jira.Priority;
...
public class JiraBoardService {
    ...
    public CompletableFuture<Void> createIssue(com.signongroup.focus.model.jira.IssueCreateRequest issueCreateRequest) {
        return CompletableFuture.supplyAsync(() -> {
            try {
