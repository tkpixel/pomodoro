...
import com.signongroup.focus.config.DefaultFocusConfig;
...
public class JsonSettingsService implements SettingsService {
    ...
    private final DefaultFocusConfig defaultConfig;

    @Inject
    public JsonSettingsService(DefaultFocusConfig defaultConfig) {
