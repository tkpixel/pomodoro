...
module com.signongroup.pomodoro {
  ...
  opens com.signongroup.pomodoro.view to
      javafx.fxml,
      io.micronaut.micronaut_inject;
  opens com.signongroup.pomodoro.view.jira to
      javafx.fxml,
      io.micronaut.micronaut_inject;

  // ── Reflection-Öffnungen für Micronaut & JavaFX ───────────────────────────
  opens com.signongroup.pomodoro to
      javafx.graphics,
      io.micronaut.micronaut_inject;
  opens com.signongroup.pomodoro.viewmodel to
      io.micronaut.micronaut_inject;
  opens com.signongroup.pomodoro.service to
      io.micronaut.micronaut_inject;
  opens com.signongroup.pomodoro.model to
      io.micronaut.micronaut_inject,
      com.fasterxml.jackson.databind;
  opens com.signongroup.pomodoro.model.jira to
      io.micronaut.micronaut_inject,
      com.fasterxml.jackson.databind;
  opens com.signongroup.pomodoro.config to
      io.micronaut.micronaut_inject;
}
